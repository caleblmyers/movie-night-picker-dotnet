    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SuggestMovieHistory", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SuggestMovieHistory_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CollectionMovies_CollectionId_TmdbId",
                table: "CollectionMovies",
                columns: new[] { "CollectionId", "TmdbId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CollectionMovies_TmdbId",
                table: "CollectionMovies",
                column: "TmdbId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Ratings_UserId_TmdbId",
                table: "Ratings",
                columns: new[] { "UserId", "TmdbId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_TmdbId",
                table: "Reviews",
                column: "TmdbId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SavedMovies_UserId_TmdbId",
                table: "SavedMovies",
                columns: new[] { "UserId", "TmdbId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_SuggestMovieHistory_TmdbId",
                table: "SuggestMovieHistory",
                column: "TmdbId");

            migrationBuilder.CreateIndex(
                name: "IX_SuggestMovieHistory_UserId",
                table: "SuggestMovieHistory",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_SuggestMovieHistory_UserId_CreatedAt",
                table: "SuggestMovieHistory",
                columns: new[] { "UserId", "CreatedAt" });

            migrationBuilder.CreateIndex(
                name: "IX_SuggestMovieHistory_UserId_TmdbId",
                table: "SuggestMovieHistory",
                columns: new[] { "UserId", "TmdbId" },
                unique: true);
